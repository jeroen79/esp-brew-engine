...
<v-container class="spacing-playground pa-6 mt-2" fluid>
  ...
  <v-form fast-fail @submit.prevent>
    ...
    <v-row>
      ...
      <v-col cols="12" md="9">
        <v-slider v-model="clientSettings.beepVolume" :label="$t('clientsettings.beep_volume')" step="0.05"
          thumb-label="always" max=1 min=0.1 />
      </v-col>
    </v-row>
    ...
    <v-row>
      ...
      <v-col cols="12" md="9">
        <v-slider v-model="clientSettings.speechVolume" :label="$t('clientsettings.speech_volume')" step="0.05"
          thumb-label="always" max=1 min=0.1 />
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col cols="12">
        <v-select :label="$t('clientsettings.voice')" v-model="clientSettings.voiceUri" :filled="voices"
          :items="voices" />
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col cols="12">
        <v-slider v-model="clientSettings.speechRate" :label="$t('clientsettings.speech_rate')" step="0.05"
          thumb-label="always" max=2 min=0.1 />
      </v-col>
    </v-row>
